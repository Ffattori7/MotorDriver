...
const uint32_t MAX_RUNTIME_MS = 15000;  // 8 seconds

// Revolutions (Motor) Setpoint
const float SETPOINT_REV = -100.0f;  // Target encoder revolutions
...
// Maximum Current 
const float CURRENT_LIMIT = 3.0f;  // [A]
float maxCurrent = 0.0f;  // [A]

// Proportional Gain
const float KP = 20.0f;  // Adjust this value for tuning
